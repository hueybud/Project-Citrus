...
extern const Info<std::string> MAIN_CITRUS_REPLAY_PATH;
...
extern const Info<bool> MAIN_MOVIE_USE_NULL_BACKEND;
...
extern const Info<bool> MAIN_MOVIE_AI_SYNCHRONOUS;
